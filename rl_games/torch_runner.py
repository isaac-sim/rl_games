...
from rl_games.algos_torch import td3_agent
...
class Runner:
    ...
    def __init__(self, algo_observer=None):
        ...
        self.algo_factory.register_builder('td3', lambda **kwargs: td3_agent.TD3Agent(**kwargs))
        ...
        self.player_factory.register_builder('td3', lambda **kwargs : players.TD3Player(**kwargs))
